...
const usuario_eliminado_1 = __importDefault(require("../models/usuario_eliminado")); // Asegúrate de tener el modelo de Usuario importado
const getUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listUsuarios = yield usuario_eliminado_1.default.findAll();
...
const getUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const usuario = yield usuario_eliminado_1.default.findByPk(id);
        if (usuario) {
            res.json(usuario);
        }
        else {
