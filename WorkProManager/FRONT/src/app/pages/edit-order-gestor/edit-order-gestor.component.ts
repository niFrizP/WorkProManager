...
@Component({
  ...
  styleUrls: ['./edit-order-gestor.component.css']
})
...
async editProduct(): Promise<void> {
  ...
  try {
    ...
    Swal.fire({
      title: 'La cotización fue rectificada con éxito!',
      text: `La cotización correspondiente al número de OT ${id} fue rectificada con éxito.`,
      icon: 'success',
